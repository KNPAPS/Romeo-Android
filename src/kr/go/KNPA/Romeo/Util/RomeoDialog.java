...
public class RomeoDialog extends Dialog {
	...
	protected RomeoDialog(Context context, int theme) {
		...
		this.view = ((LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(
				R.layout.romeo_dialog, null);
	...
	static public class Builder {
		...
		public Builder(Context context, boolean doBackgroundDim) {
			...
			if (doBackgroundDim) {
				...
				this.dialog = new RomeoDialog(context,
						R.style.RomeoDialogTheme_NoDim);
			}
		...
		public RomeoDialog create() {
			return dialog;
		}

		public RomeoDialog show() {
			dialog.show();
			return dialog;
		}

		private ImageView getIconView() {
			return ((ImageView) dialog.view.findViewById(R.id.icon));
		}

		private TextView getTitleView() {
			return ((TextView) dialog.view.findViewById(R.id.title));
		}

		private TextView getMessageView() {
			return ((TextView) dialog.view.findViewById(R.id.message));
		}

		private ListView getListView() {
			return ((ListView) dialog.view.findViewById(R.id.list));
		}

		private ExpandableListView getExpandableListView() {
			return ((ExpandableListView) dialog.view
		...
		public Builder setIcon(int iconId) {
			getIconView().setImageResource(iconId);
			return this;
		}
		...
		public Builder setAdapter(ExpandableListAdapter adapter,
				final OnGroupClickListener groupListener,
				final OnChildClickListener childListener) {
		...
		public Builder setAdapter(ExpandableListAdapter adapter,
				final OnGroupClickListener groupListener,
				final OnChildClickListener childListener,
				final OnGroupExpandListener expandListener,
				final OnGroupCollapseListener collapseListener) {
		...
		public Builder setPositiveButton(int textId,
				final DialogInterface.OnClickListener listener) {
			return setPositiveButton(context.getResources().getString(textId),
					listener);
		}

		public Builder setPositiveButton(CharSequence text,
				final DialogInterface.OnClickListener listener) {
			Button positiveBT = (Button) dialog.view
			...
			dialog.view.findViewById(R.id.buttonWrapper).setVisibility(
					View.VISIBLE);
			return this;
		}
		...
		public Builder setNegativeButton(int textId,
				final DialogInterface.OnClickListener listener) {
			return setNegativeButton(context.getResources().getString(textId),
					listener);
		}

		public Builder setNegativeButton(CharSequence text,
				final DialogInterface.OnClickListener listener) {
			Button negativeBT = (Button) dialog.view
