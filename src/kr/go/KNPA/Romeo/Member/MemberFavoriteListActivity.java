...
public class MemberFavoriteListActivity extends Activity implements MemberFavoriteListActivityLayout.Listener {
	...
	private MemberFavoriteListActivityLayout	mLayout;

	@Override
	protected void onCreate(Bundle savedInstanceState)
	{
		super.onCreate(savedInstanceState);
		mLayout = new MemberFavoriteListActivityLayout(this, R.layout.activity_member_favorite_list);

		mLayout.setListener(this);
		mLayout.setNavBarTitleTV(R.string.memberFavoriteTitle);
