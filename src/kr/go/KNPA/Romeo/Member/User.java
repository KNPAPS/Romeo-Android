...
public class User implements Parcelable {
	...
	public User clone()
	{
		return new User.Builder().idx(this.idx).name(this.name).rank(this.rank).role(this.role).department(department).pic(this.pic).build();
	}
	...
	{
		return Constants.POLICE_RANK[rank] + " " + name;
	}
}
