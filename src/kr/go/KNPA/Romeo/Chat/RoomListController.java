...
public class RoomListController extends BaseController implements RoomListLayout.Listener 
{
	private static RoomListController mCommandListController = null;
	private static RoomListController mMeetingListController = null;
	private static RoomController mCurrentRoom = null;
	...
	public static RoomListController getInstance(int subType)
	{
		RoomListController f = null;
		
		if(subType == Chat.TYPE_COMMAND) 
		{
			if(mCommandListController == null)
			{
				mCommandListController = new RoomListController(Chat.TYPE_COMMAND);
			}
		...
		else
		{
			...
			{
				mMeetingListController = new RoomListController(Chat.TYPE_MEETING);
			}
	...
	public static void setCurrentRoom(RoomController ra) 
	{
		mCurrentRoom = ra;
	}
	...
	private void goToRoomController(Room room)
	{
		...
		getActivity().getSupportFragmentManager()
			...
			.replace(R.id.content_frame, roomController, roomController.getClass().getSimpleName())
			.addToBackStack(null)
			.commit();
	}
}
