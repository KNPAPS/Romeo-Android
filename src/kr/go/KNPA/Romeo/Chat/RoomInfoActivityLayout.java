...
public class RoomInfoActivityLayout extends ActivityLayout {
	...
	public RoomInfoActivityLayout(Activity activity, int layoutResourceId)
	{
	...
	{
		mInviteChatterBtn.setVisibility(View.GONE);
	}
}
