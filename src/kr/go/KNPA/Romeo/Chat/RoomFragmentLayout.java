 ...
 * 채팅방 화면
 */
public class RoomFragmentLayout extends FragmentLayout {
	...
	public RoomFragmentLayout(Context context, LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
